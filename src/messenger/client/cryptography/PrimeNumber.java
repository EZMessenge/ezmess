...
public class PrimeNumber {
	...
	public static long get8BytesNumber(long limit) {
		long r;
		do{
			r = nextLong(new Random(), Integer.MAX_VALUE);
		}while(ByteBuffer.allocate(Long.SIZE).putLong(r).array().length==8 || r>limit);
		return r;
	}
}
